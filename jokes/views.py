...
# The following is a View Function, not a View Class
# View Functions are passed a REQUEST and maybe some arguments from the 
# URL Pattern. Then they return a WEB RESPONSE to be sent to the client    
